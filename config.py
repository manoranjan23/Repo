...
API_ID = int(getenv("API_ID"22834593))
API_HASH = getenv("API_HASH"f400bc1d1baeb9ae93014ce3ee5ea835)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/AO_Association")
